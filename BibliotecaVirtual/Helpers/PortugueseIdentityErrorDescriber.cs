...
{
    /// <summary>
    /// Classe para traduzir os erros do identity framework.
    /// </summary>
    public class PortugueseIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError LoginAlreadyAssociated()
        {
            return new IdentityError
            {
                ...
                Description = "Já existe um usuário com este Apelido."
            };
        }
        ...
        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = $"Apelido '{userName}' é inválido, pode conter apenas letras ou dígitos."
            };
        }
        ...
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = $"Apelido '{userName}' já está sendo utilizado."
            };
        }
